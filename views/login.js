...
export default function Login(props) {
  return (
    ...
    <Text style={Style.loginText}> Um jeito simples e descomplicado de fazer entregas</Text>
    <Image
    ...
    <Text style={Style.loginText}> Uma simplicidade que cabe na sua mão</Text>
    <Image
          style={Style.firstImg}
