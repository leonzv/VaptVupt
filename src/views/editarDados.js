...
<View style={Style.containerCadastro}>
      ...
      <View style={{flexDirection: 'row', justifyContent: 'center', width: '100%', marginBottom: 30, marginTop: 50,}}>
          ...
          <Text style={{ color: "white", textAlign: "center", fontSize: 16,fontFamily: "bariol_regular",}}>Deletar dados</Text>
          </TouchableOpacity>
          <TouchableOpacity style={Style.atualizarDados}>
          <Text style={{ color: "white", textAlign: "center", fontSize: 16,fontFamily: "bariol_regular",}}>Atualizar dados</Text>
          </TouchableOpacity>
      </View>
    </View>
  );
